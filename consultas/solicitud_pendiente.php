<?php
    ...
    $telefono=$_POST["telefono_sp"];
    $fecha_visita=$_POST["fecha_sp"];
    $hora_visita=$_POST["hora_sp"];

    mysqli_query($con,"INSERT INTO solicitud_pendiente (nombre_completo,domicilio,fecha_visita,hora_visita,telefono) VALUES ('$nombre','$domicilio','$fecha_visita','$hora_visita','$telefono')");
